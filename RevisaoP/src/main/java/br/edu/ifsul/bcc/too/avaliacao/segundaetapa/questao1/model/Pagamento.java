...
public class Pagamento {
    ...
    public Pagamento(Integer id, Integer numero_parcela, Calendar data_vencimento, Calendar data_pagamento, Float valor, Servico servico, FormaPagamento forma_pagamento) {
        this.id = id;
